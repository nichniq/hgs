...
export const double_portrait_mondrian = {
  title: "Shadow Double Portrait of Mondrian (In Memory of Harry Holtzman)",
...
export const kertesz_mondrian_portrait = {
  title: "Kertesz/Mondrian Portrait",
  id: "kertesz-mondrian-portrait",
  info: {
    year: "1999/2002",
    materials: "Marble and Wood",
    dimensions: "50″h. 14″w. 14″d."
  },
  images: [
    { source: "sculpture/narrative_kertesz-mondrian_01.jpg" },
...
export const proposal_for_lincoln_center = {
  title: "Space-screen Proposal for Lincoln Center / Juilliard School Bridge",
...
export const the_lapith = {
  title: "The Lapith (from the Parthenon - south metope #27)",
